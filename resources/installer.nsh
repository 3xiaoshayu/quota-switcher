...
!macro customHeader
  BrandingText "Codex Account Manager"

  LangString installerWelcomeTitle ${LANG_SIMPCHINESE} "欢迎安装"
  LangString installerWelcomeText ${LANG_SIMPCHINESE} "用来在这台电脑上管理 Codex 账号、查看额度，并在额度不够时自动换号。$\r$\n$\r$\n账号只保存在这台电脑上，不会上传。$\r$\n$\r$\n点「下一步」继续。"
  LangString installerFinishTitle ${LANG_SIMPCHINESE} "安装完成"
  LangString installerFinishText ${LANG_SIMPCHINESE} "可以从开始菜单或桌面打开。$\r$\n$\r$\n账号数据只保存在这台电脑上。"
  LangString installerFinishRun ${LANG_SIMPCHINESE} "打开 Codex Account Manager"
  ...
  LangString installerUnWelcomeTitle ${LANG_SIMPCHINESE} "卸载 Codex Account Manager"
  ...
  LangString installerUnFinishText ${LANG_SIMPCHINESE} "Codex Account Manager 已从这台电脑移除。账号数据仍留在原处。"

  LangString installerWelcomeTitle ${LANG_ENGLISH} "Install Codex Account Manager"
  LangString installerWelcomeText ${LANG_ENGLISH} "Manage Codex accounts, quotas, and automatic switching on this PC.$\r$\n$\r$\nAccount data stays on this computer.$\r$\n$\r$\nClick Next to continue."
  LangString installerFinishTitle ${LANG_ENGLISH} "You're all set"
  LangString installerFinishText ${LANG_ENGLISH} "Open Codex Account Manager from the Start menu or the desktop shortcut.$\r$\n$\r$\nAccount data stays on this computer."
  LangString installerFinishRun ${LANG_ENGLISH} "Open Codex Account Manager"
  ...
  LangString installerUnWelcomeTitle ${LANG_ENGLISH} "Uninstall Codex Account Manager"
  ...
  LangString installerUnFinishText ${LANG_ENGLISH} "Codex Account Manager has been removed. Account data was left in place."
